...
export default function EnterpriseManagePage() {
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-start justify-between mt-2">
        <div>
          ...
          <p className="text-[13px] text-muted-foreground mt-0.5">Advanced organization controls, SSO, and custom integrations</p>
        </div>
      </div>
  ...
  return (
    <ComingSoonPage
      ...
      description="Advanced organizational controls, SSO integration, and custom AI model management exclusively for Enterprise customers."
      icon={Crown}
